...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 15), // int()(argon2_context *, argon2_type)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 12), // argon2_context *
/*  2 */ _CFFI_OP(_CFFI_OP_ENUM, 0), // argon2_type
/*  3 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  4 */ _CFFI_OP(_CFFI_OP_FUNCTION, 15), // int()(uint8_t * *, size_t)
/*  5 */ _CFFI_OP(_CFFI_OP_POINTER, 9), // uint8_t * *
/*  6 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 28), // size_t
/*  7 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  8 */ _CFFI_OP(_CFFI_OP_FUNCTION, 19), // void()(uint8_t *, size_t)
/*  9 */ _CFFI_OP(_CFFI_OP_POINTER, 17), // uint8_t *
/* 10 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 28),
/* 11 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 12 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // argon2_context
/* 13 */ _CFFI_OP(_CFFI_OP_ENUM, 1), // argon2_version
/* 14 */ _CFFI_OP(_CFFI_OP_POINTER, 4), // int(*)(uint8_t * *, size_t)
/* 15 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/* 16 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 22), // uint32_t
/* 17 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 18), // uint8_t
/* 18 */ _CFFI_OP(_CFFI_OP_POINTER, 8), // void(*)(uint8_t *, size_t)
...
static const struct _cffi_global_s _cffi_globals[] = {
  ...
  { "argon2_ctx", (void *)_cffi_f_argon2_ctx, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_argon2_ctx },
};
...
static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "Argon2_Context", 12, _CFFI_F_CHECK_FIELDS,
    sizeof(argon2_context), offsetof(struct _cffi_align__argon2_context, y), 0, 18 },
};

static const struct _cffi_enum_s _cffi_enums[] = {
  { "Argon2_type", 2, _cffi_prim_int(sizeof(argon2_type), ((argon2_type)-1) <= 0),
    "Argon2_d,Argon2_i,Argon2_id" },
  { "Argon2_version", 13, _cffi_prim_int(sizeof(argon2_version), ((argon2_version)-1) <= 0),
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__argon2(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__argon2(void) { return NULL; }
#  else
     init_argon2(void) { }
#  endif
#  endif
...
PyInit__argon2(void)
{
  return _cffi_init("_argon2", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_argon2(void)
{
  _cffi_init("_argon2", 0x2601, &_cffi_type_context);
}
#endif
